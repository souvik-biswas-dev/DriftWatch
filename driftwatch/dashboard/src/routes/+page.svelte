<script lang="ts">
	...
	// path (24x24 viewBox), rendered in the brand `color` — except Express,
	// whose brand black is the footer background, so it uses a light neutral.
	const techStack = [
		{
			name: 'Node.js',
			color: '#5fa04e',
